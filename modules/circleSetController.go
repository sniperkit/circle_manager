...
// @Param	body		body 	modules.CreateCircleSet	true		"body for CircleSet content"
// @Success 201 {int} modules.CircleSet
// @Failure 403 body is empty
// @router / [post]
// @Security userAPIKey
func (c *CircleSetController) Post() {
	c.BasePost(&CreateCircleSet{}, &CircleSet{})
}
...
// @Param	body		body 	modules.UpdateCircleSet	true		"body for CircleSet content"
// @Success 200 {object} modules.CircleSet
// @Failure 403 :id is not int
// @router /:id [put]
// @Security userAPIKey
func (c *CircleSetController) Put() {
	c.BasePut(&UpdateCircleSet{}, &CircleSet{})
}
