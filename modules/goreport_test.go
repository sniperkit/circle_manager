...
type NotificationTypeTest struct {
	...
	TitleTemplateForSMS             string `description:""`
	MessageTemplateForSMS           string `description:""`
	ListItemTemplateForSMS          string `description:""`
	TitleTemplateForEmail           string `description:""`
	MessageTemplateForEmail         string `description:""`
	ListItemTemplateForEmail        string `description:""`
	TitleTemplateForWeb             string `description:""`
	MessageTemplateForWeb           string `description:""`
	ListItemTemplateForWeb          string `description:""`
	TitleTemplateForSlack           string `description:""`
	MessageTemplateForSlack         string `description:""`
	ListItemTemplateForSlack        string `description:""`
	TitleTemplateForWebhook         string `description:""`
	MessageTemplateForWebhook       string `description:""`
	ListItemTemplateForWebhook      string `description:""`
...
func TestMakeNotificationByInterface(t *testing.T) {
	...
	notiType := &NotificationTypeTest{
		TitleTemplateForWebhook:    "title {{now_day}} {{now_month}}",
		MessageTemplateForWebhook:  "message {{_object1__name}} {{_object2__val}}\n{{list}}",
		ListItemTemplateForWebhook: "- {{key}} {{key1}} {{key2}}\n",
