...
// type parseFile func(status, l string, targetFile interface{})

// func Import(rawFilePath string, cs *CircleSet, targetFile interface{}, targetParseFile parseFile) error {
...
// 		targetParseFile(status, l, targetFile)
// 		lineIndex++
// 	}
// 	return nil
// }
