...
// @Param	body		body 	requests.CreateEmployee	true		"body for Employee content"
// @Success 201 {int} responses.ResponseEmployee
...
// @Param	body		body 	requests.UpdateEmployee	true		"body for Employee content"
// @Success 200 {object} responses.ResponseEmployee
